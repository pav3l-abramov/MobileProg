...
fun <E> transpose(matrix: Matrix<E>): Matrix<E> {
    ...
    val result = createMatrix(height = matrix.width, width = matrix.height,  matrix[0, 0])
...
operator fun Matrix<Int>.unaryMinus(): Matrix<Int> {
    val result = createMatrix(height = this.height, width = this.width,  0)
...
operator fun Matrix<Int>.times(other: Matrix<Int>): Matrix<Int> {
    ...
    val result = createMatrix(height = this.height, width = other.width, 0)
